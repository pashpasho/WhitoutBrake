...
{
#pragma warning disable CS0246 // The type or namespace name 'WaypointsMover' could not be found (are you missing a using directive or an assembly reference?)
    [CustomEditor(typeof(WaypointsMover))]
#pragma warning restore CS0246 // The type or namespace name 'WaypointsMover' could not be found (are you missing a using directive or an assembly reference?)
